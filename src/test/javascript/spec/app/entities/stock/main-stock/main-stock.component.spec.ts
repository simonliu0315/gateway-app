...
import { MainStockComponent } from 'app/entities/stock/main-stock/main-stock.component';
...
describe('Component Tests', () => {
  describe('MainStock Management Component', () => {
    let comp: MainStockComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MainStockComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.mainStocks && comp.mainStocks[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
